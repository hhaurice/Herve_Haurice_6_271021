...
const passwordValidator = () => {
  return [
    ...
    .withMessage("Mot de passe doit contenir au moins 8 caractères dont une majuscule, un symbole et un chiffre")
  ]
};
...
const validate = (req, res, next) => {
  ...
  return res.status(422).json({errors: "Mot de passe doit contenir au moins 8 caractères contenant une majuscule, un symbole et un chiffre"})
